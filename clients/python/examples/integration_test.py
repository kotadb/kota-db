...
class IntegrationTestSuite:
    ...
    def setup(self):
        ...
        print(f"🔧 Setting up integration tests...")
    ...
    def test_basic_crud_operations(self):
        ...
        try:
            ...
            updated_doc = self.db.update(doc_id, {
    ...
    def test_builder_patterns(self):
        ...
        try:
            ...
            updated_doc = self.db.update_with_builder(doc_id,
                UpdateBuilder()
                .add_tag("updated")
                .add_metadata("last_test", "builder_update")
            )
            self.assert_test(
                "updated" in updated_doc.tags,
