...
import statistics
import uuid
from kotadb import KotaDB, DocumentBuilder, QueryBuilder
...
class PerformanceTestSuite:
    ...
    def setup(self):
        ...
        print(f"🔧 Setting up performance tests...")
    ...
    def test_builder_pattern_performance(self, count=50):
        ...
        try:
            ...
            overhead = ((builder_stats["avg_ms"] - trad_stats["avg_ms"]) / trad_stats["avg_ms"]) * 100
