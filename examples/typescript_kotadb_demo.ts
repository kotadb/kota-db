...
const {
  ...
  ValidationError,
  KotaDBError
} = require('../clients/typescript/dist/types.js');
...
function printDocument(doc: any, indent: string = ''): void {
...
async function demoConnectionManagement(dbUrl: string = TEST_SERVER_URL): Promise<any> {
...
async function demoDocumentOperations(db: any): Promise<string[]> {
...
async function demoSearchOperations(db: any): Promise<void> {
...
async function demoBulkOperations(db: any, docIds: string[]): Promise<void> {
...
async function demoAdvancedSearch(db: any): Promise<void> {
...
async function demoErrorHandling(db: any): Promise<void> {
...
async function cleanupDemoDocuments(db: any, docIds: string[]): Promise<void> {
